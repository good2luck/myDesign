package com.pattern._3singleton.base;
 ...
 */
public class SingletonWay5 {
	
	private static SingletonWay5 instance;
	
	private SingletonWay5(){};
	
	public static SingletonWay5 getSingleton(){
		if(instance == null){
			synchronized(SingletonWay5.class){
				if(instance == null){
					instance = new SingletonWay5();
				}
			}
		}
		return instance;
